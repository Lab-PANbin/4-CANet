...
class ResNetBackbone(Backbone):
    ...
    def CANet(self, num_classes, modifier):
        """
        Returns a retinanet model using the correct backbone.
        """
        return resnet_CANet(num_classes=num_classes, backbone=self.backbone, modifier=modifier)
...
def resnet_CANet(num_classes, backbone='resnet50', modifier=None):
    """
    Constructs a retinanet model using a resnet backbone.
    ...
    # create the full model
    return retinanet.CANet(inputs=[image_input, gt_boxes_input, feature_shapes_input],
